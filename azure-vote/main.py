...
from opencensus.stats import measure as measure
...
app_insight_key = app.config['APP_INSIGHT_KEY']
...
exporter = metrics_exporter.new_metrics_exporter(
    enable_standard_metrics=True, connection_string=app_insight_key)
...
def index():
    ...
    if request.method == 'GET':
        ...
        # QuyenLN2: use tracer object to trace cat vote
        tracer.span(name="Cats")

        vote2 = r.get(button2).decode('utf-8')
        # QuyenLN2: use tracer object to trace dog vote
